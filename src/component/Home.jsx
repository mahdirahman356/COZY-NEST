      ...
      <div className="hero mt-3 md:mt-9 rounded-3xl" style={{ backgroundImage: `url(${HeroImage})` }}>
        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className='md:w-[50%] mt-5 animate__animated animate__slideInLeft'>
            ...
            <div>
              <div className="carousel carousel-center max-w-md p-4 space-x-4  rounded-box animate__animated animate__slideInRight">
